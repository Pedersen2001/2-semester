...
function printScoreTableHdrHTML(){
  ...
  <p>Click here for the <a href="resources/help.html">Help Page</a> or click here for the <a href="https://da.wikipedia.org/wiki/Yatzy">Yatzy Rules</a></p>
  ...
  for(let round=0;round<scoreTable.length;round++) {
    ...
    if(!isSpecialRound(round)){
      ...
      for(let d=0;d<scoreTable[round].diceRoll.length;d++){
         ...
         res+=`<img src="resources/${imgName}-dice.png" width="20" height="20" title="dice ${imgName}">`;
      }
      res+="</span>";
    }
    res+="</td>"
